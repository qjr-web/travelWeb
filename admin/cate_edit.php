                    	...
                    	<tr>
                            ...
                            <td>
								<select name="module" class="inbox">
									<option value="旅游故事" <?php  if($row['module']=='旅游故事'){echo 'selected="selected"';}?>>旅游故事</option>
									<option value="旅游攻略" <?php  if($row['module']=='旅游攻略'){echo 'selected="selected"';}?>>旅游攻略</option>
								</select>
							</td>
                        </tr>
                    	<tr>
