...
?>
        <div class="mainbox">
            <div class="note">
				...
				------>
                <form action="./story_edit_save.php" method="post" enctype="multipart/form-data">
					...
					<table cellspacing="0" class="news_form">
                    	...
                    	<tr>
                            ...
                            <td>
							<!---
							要实现修改新闻时显示老的新闻分类，分两步实现：
							1、将新闻分类数据显示出来
							2、把新闻原来的分类设置为select下拉框的默认值
							--->
								<select name="cate_id" class="inbox">
									<?php 
									$sql="select * from category where module='旅游故事' order by orderno asc,id desc";
